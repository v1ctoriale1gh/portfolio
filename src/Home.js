    ...
    render() {
        return (
            ...
            <Container >
                ...
                Reared in Charleston, SC but raised in Atlanta, GA I spend my time developing projects, learning new tech skills, hiking and philosophizing about life with my partner, two dogs, and bearded dragon in The Big Peach and Georgia Foothills.</p>
                </Container>
        );
    }
}
